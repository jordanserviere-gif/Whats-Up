...
| **Dette de l'axe des distances** | l'erreur laissee par la crete que deux anneaux consecutifs sautent, rapportee a la cible de seize pixels : **17 320 px a 0,02° de champ, 693 a 0,5°, 173 a 2°**, puis 17 a 20° et 15,8 a 110°. Au-dela de vingt degres la cible est tenue ; en deca elle ne l'est pas, et **le facteur ne se rattrape pas** — tenir seize pixels a deux degres demanderait quatre mille anneaux contre quatre cent seize. C'est la limite de la representation radiale, pas un reglage : la franchir demande un quadtree ou une marche par pixel.  ⚠️ **Une loi suivant la caméra a été essayée et retirée** : sonder le relief pour trouver la bande de distances visible donnait bien un anneau tous les 2,8 m à 3,1 km au lieu de 124, mais depuis un sommet visant l'horizon la bande commence vers 16 km, et les anneaux laissés en dessous couvraient alors 0,5 m à 16 km — **28 % d'écart**, une facette géante masquant tout le paysage. Le principe tient ; la faute est de répartir les queues en logarithme de la distance là où il faut les répartir en **hauteur apparente**. |
