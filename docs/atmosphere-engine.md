...
| **Le crépuscule profond est trop sombre** | ⚠️ **mesuré, non corrigé.** Sous −10° de hauteur solaire, l'éclairement du ciel s'effondre bien plus vite que la courbe classique : ×0,26 à −10°, ×0,15 à −14°, ×0,11 à −16°. Au-dessus de −10° l'accord est bon (×0,95 à −6°, ×0,82 à −8°). **Ce n'est pas une question de résolution** : converger la table de diffusion multiple *aggrave* le déficit — 8,3·10⁻⁴ lx à 32×32, 4,2·10⁻⁴ à 128×128 avec 256 directions, pour 5,5·10⁻³ attendus à −14°. C'est la **localité du modèle** : sous −10°, la diffusion simple est rigoureusement nulle — toute l'atmosphère accessible est dans l'ombre de la Terre — et le ciel ne tient plus que par `Ψ_ms(altitude, cos☉)`, une fonction **locale** du point. Or la lumière qui éclaire un point d'ombre à vingt kilomètres vient d'air ensoleillé situé à des centaines de kilomètres, à une tout autre altitude et un tout autre angle solaire : une table indexée sur le point lui-même ne peut pas la porter. La méthode de Hillaire vise le ciel de jour, et c'est là qu'elle tient. **Conséquence visible** : la bande d'horizon paraît trop intense parce que le ciel au-dessus est trop noir — rapport horizon/zénith de 20 à 66 là où l'on observe 3 à 10. |
