...
| **Carte d'ombre du relief** | ⚠️ **c'est desormais l'element le plus grossier de l'image.** 512 texels sur ±60 km font **234 m par texel**, soit 2,69° a 5 km et 0,45° a 30 km — contre 0,036° pour une colonne du maillage. A deux degres de champ, un texel d'ombre couvre **201 pixels a 30 km et 1209 a 5 km**, quand le maillage en tient seize. Les ombres portees du relief proche sont donc des taches, pas des formes. Visible sous forme de bandes douces des que le Soleil est bas — c'est-a-dire quand on regarde. Le correctif est le meme que celui du maillage : faire suivre la resolution a l'ecran, ce que la machinerie de `meshSampling` sait deja faire. |
